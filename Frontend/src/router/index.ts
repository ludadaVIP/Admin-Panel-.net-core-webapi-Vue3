...
import MenuCenter from '../view/admin/menu/MenuManager.vue'
...
let routes = [
    {
        path: "/", name : 'desktop', component: RootPage,
        children: [
            { name: "Dashboard", path: "/desktop", component: DeskTop },
            { name: "Person Center", path: "/person", component: PersonCenter },
        ]
    },
