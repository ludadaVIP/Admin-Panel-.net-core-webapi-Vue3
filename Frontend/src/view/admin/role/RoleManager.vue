...
<template>
  <el-card class="box-card">
      ...
      <div class="card-header">
        <el-form :inline="true" :model="form" class="demo-form-inline" :rules="rules" ref="ruleFormRef">
          <el-form-item label="Name" prop="name">
            <el-input v-model="form.name" placeholder="Please input a name" />
          </el-form-item>
          <el-form-item>
        ...
        <p>
          ...
          <el-button type="primary" @click="Seting">Assign Menu</el-button>
        </p>
      </div>
    </template>
    <el-table :data="tableData" style="width: 100%" ref="multipleTableRef">
      ...
      <el-table-column label="Action" align="right" width="200">
        <template #default="scope">
